...
mkdir ~/Tools
mkdir ~/Tools/bin
pacman -S i3-gaps i3blocks i3lock i3status polybar rofi firefox ntfs-3g pulseaudio lxappearance arandr git kitty zsh newsboat neovim pulseaudio-alsa alsa-utils picom cmus redshiftbase-devel curl wget xdotool tmux
...
cp ~/i3installconfig/zshrc ~/.zhsrc
